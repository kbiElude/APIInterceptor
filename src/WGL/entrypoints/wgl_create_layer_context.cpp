                                       ...
                                       int in_layer_plane_index)
{
    ...
    if (APIInterceptor::get_callback_for_function(APIInterceptor::APIFUNCTION_WGL_WGLCREATELAYERCONTEXT,
                                                  &callback_func_ptr,
                                                  &callback_func_arg) )
    {
        ...
        callback_func_ptr(APIInterceptor::APIFUNCTION_WGL_WGLCREATELAYERCONTEXT,
