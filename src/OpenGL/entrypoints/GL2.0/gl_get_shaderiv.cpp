                                       ...
                                       GLint* params)
{
    ...
    if (OpenGL::g_cached_gl_get_shaderiv == nullptr)
    {
        OpenGL::g_cached_gl_get_shaderiv = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glGetShaderiv");
    }
