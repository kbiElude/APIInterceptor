                                      ...
                                      const GLint* value)
{
    ...
    if (OpenGL::g_cached_gl_uniform_1iv == nullptr)
    {
        OpenGL::g_cached_gl_uniform_1iv = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glUniform1iv");
    }
