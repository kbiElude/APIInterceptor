                                           ...
                                           const GLbyte* v)
{
    ...
    if (OpenGL::g_cached_gl_vertex_attrib_4bv == nullptr)
    {
        OpenGL::g_cached_gl_vertex_attrib_4bv = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glVertexAttrib4bv");
    }
