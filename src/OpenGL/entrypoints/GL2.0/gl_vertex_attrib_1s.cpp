                                          ...
                                          GLshort x)
{
    ...
    if (OpenGL::g_cached_gl_vertex_attrib_1s == nullptr)
    {
        OpenGL::g_cached_gl_vertex_attrib_1s = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glVertexAttrib1s");
    }
