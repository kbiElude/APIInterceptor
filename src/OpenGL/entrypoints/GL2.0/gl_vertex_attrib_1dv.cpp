                                           ...
                                           const GLdouble* v)
{
    ...
    if (OpenGL::g_cached_gl_vertex_attrib_1dv == nullptr)
    {
        OpenGL::g_cached_gl_vertex_attrib_1dv = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glVertexAttrib1dv");
    }
