                                             ...
                                             const GLuint* v)
{
    ...
    if (OpenGL::g_cached_gl_vertex_attrib_4Nuiv == nullptr)
    {
        OpenGL::g_cached_gl_vertex_attrib_4Nuiv = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glVertexAttrib4Nuiv");
    }
