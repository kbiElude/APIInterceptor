                                     ...
                                     GLint v3)
{
    ...
    if (OpenGL::g_cached_gl_uniform_4i == nullptr)
    {
        OpenGL::g_cached_gl_uniform_4i = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glUniform4i");
    }
