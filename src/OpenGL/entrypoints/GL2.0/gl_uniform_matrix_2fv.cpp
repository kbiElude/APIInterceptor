                                            ...
                                            const GLfloat* value)
{
    ...
    if (OpenGL::g_cached_gl_uniform_matrix_2fv == nullptr)
    {
        OpenGL::g_cached_gl_uniform_matrix_2fv = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glUniformMatrix2fv");
    }
