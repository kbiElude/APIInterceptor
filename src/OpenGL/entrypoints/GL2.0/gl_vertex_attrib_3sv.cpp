                                           ...
                                           const GLshort* v)
{
    ...
    if (OpenGL::g_cached_gl_vertex_attrib_3sv == nullptr)
    {
        OpenGL::g_cached_gl_vertex_attrib_3sv = reinterpret_cast<WGL::PFNWGLGETPROCADDRESSPROC>(WGL::g_cached_get_proc_address_func_ptr)("glVertexAttrib3sv");
    }
