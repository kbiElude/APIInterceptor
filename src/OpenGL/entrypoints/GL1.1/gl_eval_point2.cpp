                                      ...
                                      GLint j)
{
    ...
    if (tracker.is_top_level_api_call() )
    {
        ...
        if (APIInterceptor::get_pre_callback_for_function(APIInterceptor::APIFUNCTION_GL_GLEVALPOINT2,
                                                         &callback_func_ptr,
                                                         &callback_func_arg) )
        {
            const APIInterceptor::APIFunctionArgument args[] =
            {
                ...
                APIInterceptor::APIFunctionArgument::create_i32(j),
            };

            callback_func_ptr(APIInterceptor::APIFUNCTION_GL_GLEVALPOINT2,
