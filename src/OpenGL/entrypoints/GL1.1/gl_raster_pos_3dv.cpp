...
void AI_APIENTRY OpenGL::aiRasterPos3dv(const GLdouble* v)
{
    ...
    if (APIInterceptor::get_pre_callback_for_function(APIInterceptor::APIFUNCTION_GL_GLRASTERPOS3DV,
                                                     &callback_func_ptr,
                                                     &callback_func_arg) )
    {
        ...
        callback_func_ptr(APIInterceptor::APIFUNCTION_GL_GLRASTERPOS3DV,
