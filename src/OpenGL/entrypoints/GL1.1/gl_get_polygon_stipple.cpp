...
void AI_APIENTRY OpenGL::aiGetPolygonStipple(GLubyte* mask)
{
    ...
    if (APIInterceptor::get_pre_callback_for_function(APIInterceptor::APIFUNCTION_GL_GLGETPOLYGONSTIPPLE,
                                                     &callback_func_ptr,
                                                     &callback_func_arg) )
    {
        ...
        callback_func_ptr(APIInterceptor::APIFUNCTION_GL_GLGETPOLYGONSTIPPLE,
