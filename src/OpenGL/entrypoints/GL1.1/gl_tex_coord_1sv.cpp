...
void AI_APIENTRY OpenGL::aiTexCoord1sv(const GLshort* v)
{
    ...
    if (tracker.is_top_level_api_call() )
    {
        ...
        if (APIInterceptor::get_pre_callback_for_function(APIInterceptor::APIFUNCTION_GL_GLTEXCOORD1SV,
                                                         &callback_func_ptr,
                                                         &callback_func_arg) )
        {
            ...
            callback_func_ptr(APIInterceptor::APIFUNCTION_GL_GLTEXCOORD1SV,
